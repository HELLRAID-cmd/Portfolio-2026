...
## Это мой персональный сайт-портфолио, в котором собрана основная информация обо мне, моих навыках и реализованных проектах.

![Главная страница](client/public/img/github/github.png)
...
## Важная информация:
Во время разработки проекта возникла проблема с npm, из-за которой корректная работа зависимостей была нарушена.
В результате проект пришлось полностью перенести в новый репозиторий и заново развернуть окружение.
[Оригинальная ссылка на проект](https://github.com/HELLRAID-cmd/Portfolio/)
